...
//  { name: "foam/u2/Element", flags: ['web'] },
  ...
  { name: "foam/u2/grid/GridView", flags: ['web'] },
  { name: "foam/u2/grid/GridCell", flags: ['web'] },
  { name: "foam/u2/grid/GridHeaderCell", flags: ['web'] },
